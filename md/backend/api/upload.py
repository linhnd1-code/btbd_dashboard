...
async def upload_video_chunk(
    ...
    if uploaded_chunks == total_chunks:
        ...
        os.rmdir(temp_dir)
        return {"status": "success", "message": "Đã ghép nối và tải video thành công!", "path": final_path}
    
    return {"status": "processing", "message": f"Đã nhận mảnh {chunk_index + 1}/{total_chunks}"}
